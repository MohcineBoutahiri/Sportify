document.addEventListener("DOMContentLoaded", () => {
    ...
    const checkDateTimeSelection = () => {
        ...
        if (selectedDate && time) {
            ...
            const selectedField = document.querySelector("#field-list li.active");
            if (selectedField) {
                const fieldName = selectedField.textContent.trim(); // Get the field name
                ...
                if (!isReserved) {
                    ...
                    goToPaymentButton.addEventListener("click", () => {
                        window.location.href = "../Payment/payment.html"; // Path to the payment page
                    });
                } else {
